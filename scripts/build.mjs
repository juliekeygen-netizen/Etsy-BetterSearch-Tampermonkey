...
// Parse the final concatenated production bundle and standalone scripts before
// writing anything. This catches cross-module declarations and popup/background
// syntax problems before CI uploads artifacts.
try {
