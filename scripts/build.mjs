...
const diagnosticsBackgroundStability = await readFile(resolve(diagnosticsRoot, 'background-stability.js'), 'utf8');
...
const diagnosticsStability = await readFile(resolve(diagnosticsRoot, 'stability.js'), 'utf8');
...
try {
  ...
  new Function(diagnosticsBackgroundStability);
  ...
  new Function(diagnosticsStability);
} catch (error) {
...
await Promise.all([
  ...
  writeFile(resolve(diagnosticsDir, 'background-stability.js'), `${diagnosticsBackgroundStability.trim()}\n`, 'utf8'),
  ...
  writeFile(resolve(diagnosticsDir, 'stability.js'), `${diagnosticsStability.trim()}\n`, 'utf8'),
  writeFile(
