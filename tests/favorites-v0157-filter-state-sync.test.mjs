...
test('0.15.9 keeps the v0.15.7 filter-state boundary final after diagnostics geometry', () => {
  ...
  assert.match(requires.at(-1) || '', /\/src\/104-favorites-v0157-filter-state-sync\.js\?v=0\.15\.9$/);
});
