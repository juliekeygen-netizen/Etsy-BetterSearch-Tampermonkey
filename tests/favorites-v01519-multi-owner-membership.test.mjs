...
test('module loads between cache bootstrap and immutable snapshot writer at release version', async () => {
  ...
  const cache = userscript.indexOf('/src/61e-favorites-cache-bootstrap.js?v=0.15.28');
  const membership = userscript.indexOf('/src/61eb-favorites-multi-owner-membership.js?v=0.15.28');
  const snapshot = userscript.indexOf('/src/61ea-favorites-immutable-snapshots.js?v=0.15.28');
