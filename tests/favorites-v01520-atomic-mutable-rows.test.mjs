...
test('load order makes atomic integration the module-75 fallback at release version', async () => {
  ...
  const primitive = userscript.indexOf('/src/61ab-favorites-atomic-mutations.js?v=0.15.28');
  const hardening = userscript.indexOf('/src/73-favorites-phase5-hardening.js?v=0.15.28');
  const runtimeGuard = userscript.indexOf('/src/74-favorites-phase5-runtime-guard.js?v=0.15.28');
  const integration = userscript.indexOf('/src/74a-favorites-atomic-mutable-rows.js?v=0.15.28');
  const lease = userscript.indexOf('/src/75-favorites-phase5-multitab-lease.js?v=0.15.28');
