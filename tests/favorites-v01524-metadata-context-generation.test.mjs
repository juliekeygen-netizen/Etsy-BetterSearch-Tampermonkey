...
test('release loads 106 after final renderer at v0.15.28 identity', () => {
  const p105 = userscript.indexOf('/src/105-favorites-v01512-atomic-render.js?v=0.15.28');
  const p106 = userscript.indexOf('/src/106-favorites-v01524-metadata-context-generation.js?v=0.15.28');
