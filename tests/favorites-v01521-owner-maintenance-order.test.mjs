...
test('final userscript order reasserts owner maintenance after 61h at release identity', async () => {
  ...
  const membership = userscript.indexOf('/src/61eb-favorites-multi-owner-membership.js?v=0.15.28');
  const coordinator = userscript.indexOf('/src/61h-favorites-metadata-coordinator.js?v=0.15.28');
  const finalOwner = userscript.indexOf('/src/61ha-favorites-owner-maintenance-final.js?v=0.15.28');
  const ui = userscript.indexOf('/src/62-favorites-ui.js?v=0.15.28');
