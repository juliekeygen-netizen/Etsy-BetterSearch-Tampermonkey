...
test('release load order is 99 -> 99a -> 100 at 0.15.26 identity', () => {
  const p99 = userscript.indexOf('/src/99-favorites-v0131-correctness.js?v=0.15.26');
  const p99a = userscript.indexOf('/src/99a-favorites-native-query-ack.js?v=0.15.26');
  const p100 = userscript.indexOf('/src/100-favorites-all-search-clear-parity.js?v=0.15.26');
